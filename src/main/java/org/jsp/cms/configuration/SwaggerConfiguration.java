package org.jsp.cms.configuration;
...
public class SwaggerConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		localhost.setDescription("Development of College_Management_System");
		Contact contact = new Contact();
		contact.setEmail("haribab369@gmail.com");
		contact.setName("College_Management_System");
		contact.setUrl("http://localhost:8080/users");
		License mitLicense = new License().name("MIT License").url("https://localhost:8080");
		Info info = new Info().title("College_Management_System").version("1.0").contact(contact)
